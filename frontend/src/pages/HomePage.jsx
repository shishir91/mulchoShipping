...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>MulCho Dropshipping | Nepal's Dropshipping Hub</title>
        <meta
          name="description"
          content="Start your dropshipping journey in Nepal with MulCho. Join our Messenger and Discord community to sell verified products easily."
        />
        <meta
          name="keywords"
          content="dropshipping, Nepal, ecommerce, MulCho, start online business, Shopify alternative Nepal"
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="MulCho Dropshipping" />
        <meta
          property="og:description"
          content="Your trusted dropshipping solution in Nepal."
        />
        <meta
          property="og:image"
          content="https://mulcho.com.np/images/logo.png"
        />
        <meta property="og:url" content="https://mulcho.com.np" />
